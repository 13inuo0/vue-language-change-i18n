<template>
  <div class="w-full ">
    ...
    <div class="mb-4">
      <div
        class="p-4 bg-linear-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-2xl text-white shadow-lg"
      >
    ...
    <div class="space-y-3">
      <div
        v-for="payment in filterdPayments"
        :key="payment.id"
      ...
      >
        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <span
            ...
            "
          >
            {{ payment.status === "completed" ? "정산완료" : "정산대기" }}
          </span>
        </div>
...
// 정산 내역 필터링 함수
const filterdPayments = computed(() => {
...
\n상태 : ${payment.status === "completed" ? "정산완료" : "정산대기"}
`);
}
</script>
